...
// ВЕРСИЯ 16 - ИСПРАВЛЕНО: системный alert с новым текстом

// Проверка загрузки
console.log('🔄 purchase.js v=16 loaded - system alert with new text');
            ...
            document.getElementById('open-payment-btn').addEventListener('click', function() {
                ...
                const checkInterval = setInterval(async () => {
                    ...
                    if (hasSub) {
                        ...
                        alert('✅ Оплата прошла успешно!\n\nЗакройте окно оплаты и вернитесь в приложение');
